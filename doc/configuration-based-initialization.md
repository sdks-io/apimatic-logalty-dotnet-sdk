...
using Environment = LogaltyCertificateIssuanceApiCerty.Standard.Environment;
...
var client = LogaltyCertificateIssuanceApiCertyClient.Builder
...
```csharp
{
  "LogaltyCertificateIssuanceApiCerty": {
    "Environment": "production",
    "CertyServer": "certyServer",
